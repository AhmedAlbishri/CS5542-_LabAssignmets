...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("motorbikes", "airplanes","trains")
  ...
  def generateNaiveBayesModel(sc: SparkContext): Unit = {
    ...
    val NaiveBayesModel = NaiveBayes.train(parsedData, lambda = 1.0, modelType = "multinomial")
  ...
  def main(args: Array[String]) {
    ...
    /**
      ...
      *
      * This shall be used as a input to Naive Bayes Classifier to create a model
      */
